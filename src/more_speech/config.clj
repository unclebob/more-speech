...
(def auto-thanks-fortune :off) ;{:off :normal :markov :insane}
...
(def nostr-name-reference-pattern #"nostr:[\w\-]+")
(def user-reference-pattern #"@[\w\-]+")
(def id-reference-pattern #"\@[0-9a-f]{64}")
(def nostr-npub-reference-pattern #"nostr:(npub1[qpzry9x8gf2tvdw0s3jn54khce6mua7l]+)")
