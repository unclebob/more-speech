(ns more-speech.data-storage-imp
  (:require
...
(defmethod data-storage/write-relays :files []
...
(defmethod data-storage/write-keys :files [keys]
...
(defmethod data-storage/write-tabs :files []
...
(defmethod data-storage/write-user-configuration :files []
...
(defn write-configuration []
  ...
  (data-storage/write-user-configuration)
